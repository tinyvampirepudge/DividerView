...
/**
 * @Description: 隐式Intent调用——调起DividerDemo应用的H页面，singleTop启动模式，allowTaskReparenting=true
 *
...
public class HActivity extends AppCompatActivity {
    public static final String TAG = HActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_to_main).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MainActivity.actionStart(HActivity.this);
            }
        });
    }
